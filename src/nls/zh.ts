...
export const zh: Translation = {
  ...
  'model.dola-seed-2.0-mini.detail': 'Dola大模型家族全模态理解模型，更短的思考长度，更高的tokens效率',
  'model.dola-seed-2.0-lite.detail': 'Dola大模型家族首款全模态理解模型，支持视频、图像、音频、文本原生统一理解，同时升级Agent、Coding与GUI能力',
